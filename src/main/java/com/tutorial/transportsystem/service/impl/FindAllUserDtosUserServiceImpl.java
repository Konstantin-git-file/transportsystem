...
import com.tutorial.transportsystem.service.FindAllUserDtosUserService;
...
public class FindAllUserDtosUserServiceImpl implements FindAllUserDtosUserService {
    ...
    public List<UserDto> findAllUserDtos(Integer limit, Integer offset) {
        return userMapper.usersToUserDTO(userRepository.findAll(PageRequest.of(offset, limit)).toList());
    }
}
